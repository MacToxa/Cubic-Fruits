...
import net.mcreator.cubicfruits.procedures.DumbbellUseProcedure;
...
public class DumbbellItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.cubic_fruits.dumbbell.description_0"));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		DumbbellUseProcedure.execute(entity);
		return retval;
	}
}