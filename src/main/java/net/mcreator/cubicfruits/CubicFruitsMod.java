package net.mcreator.cubicfruits;
...
@Mod("cubic_fruits")
public class CubicFruitsMod {
	public static final Logger LOGGER = LogManager.getLogger(CubicFruitsMod.class);
	public static final String MODID = "cubic_fruits";

	public CubicFruitsMod(IEventBus modEventBus) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		NeoForge.EVENT_BUS.register(this);
		modEventBus.addListener(this::registerNetworking);

		CubicFruitsModItems.REGISTRY.register(modEventBus);
